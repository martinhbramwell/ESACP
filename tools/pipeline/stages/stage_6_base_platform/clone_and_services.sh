...
# Stage 6b (thin orchestrator): clone apps + services + BaRe envars
# Sections: A2d (ce_sri family + BaRe), A3+A3b (supervisor), B2b (npm), C (BaRe envars)
...
bash /tmp/section_c_bare_envars.sh "$BENCH_DIR" "$ERP_USER" "$PROVISION_MODE"
