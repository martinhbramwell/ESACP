...
- **Trigger** — every 5–7 sessions, OR when carry-forward operator-reminders cross 3+ unresolved items, whichever comes first. The threshold is rough; operator may invoke earlier when the reminder list visibly grows session-over-session without attrition.
