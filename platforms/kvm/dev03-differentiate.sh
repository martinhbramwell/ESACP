...
export ERPNEXT_SITE="dev03"
export ERPNEXT_DNS="dev03"
export ERPNEXT_TLD="blue"
export ERPNEXT_DOMAIN="dev03.iridium.blue"
export ERPNEXT_SITE_URL="dev03.iridium.blue"
export ERP_USER_NAME="erpadm"
export ERPNEXT_SITE_NICKNAME="D3IRBL"
export TARGET_BENCH_NAME="frappe-bench-D3IRBL"
export TARGET_BENCH="$HOME/frappe-bench-D3IRBL"
...
sudo -u "$ERP_USER" mkdir -p "$BENCH_DIR/sites/$SITE_URL/private/files"
  sudo -u erpadm cp /tmp/ddlViews.sql /home/erpadm/frappe-bench-D3IRBL/sites/dev03.iridium.blue/private/files/ddlViews.sql
...
sudo tee /etc/nginx/sites-available/dev03.iridium.blue > /dev/null << 'NGINXEOF'
upstream frappe-frappe-bench-D3IRBL-dev03.iridium.blue {
    server 127.0.0.1:8000;
}
upstream frappe-socketio-frappe-bench-D3IRBL {
    server 127.0.0.1:9000;
}

server {
    listen 80;
    server_name dev03.iridium.blue;
...
server {
    ...
    root /home/erpadm/frappe-bench-D3IRBL/sites;
    ...
    location ~ ^/files/.*$ {
        try_files /dev03.iridium.blue/public$uri @webserver;
    }
    ...
    location /socket.io {
        ...
        proxy_pass http://frappe-socketio-frappe-bench-D3IRBL;
    }
    ...
    location @webserver {
        ...
        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
        proxy_set_header X-Forwarded-Proto $scheme;
        proxy_set_header X-Frappe-Site-Name dev03.iridium.blue;
        proxy_set_header X-Use-X-Accel-Redirect True;
        proxy_read_timeout 120;
        proxy_pass http://frappe-frappe-bench-D3IRBL-dev03.iridium.blue;
    }
